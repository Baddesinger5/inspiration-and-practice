...
export default function CartBtn({cartBtn}) { //функция для отображения компонента кнопки
    return (
        <div className="cartBtn-wrapper">
            
            <button className="cartBtn-item">
...
//создаем  компонент, а в нем у нас ссылка, которая везед на страницу корзины
//в кнопке есть счетчик, отображает количество товаров